  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 hidden lg:flex flex-col">
      <div className="h-20 flex items-center px-6 border-b border-slate-800">
        <div className="h-10 w-10 bg-[#3b823e] rounded-lg mr-3 flex items-center justify-center font-black text-white shadow-lg text-xs">SGA</div>
        <span className="font-bold text-white text-md tracking-tight uppercase">SGA ADMIN</span>
      </div>
      ...
      <div className="p-6 border-t border-slate-800 mt-auto bg-black/10">
        <button 
          onClick={() => alert('Suporte Técnico SGA: (85) 3456-7890')}
